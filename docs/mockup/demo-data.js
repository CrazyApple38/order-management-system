...
// 社員ダミーデータは mock-employees-data.js を単一情報源にする。
// isOnLeave: 休み申請を提出済みの社員。workedPrevNight: 前日に夜勤をしていた社員。
const employeesData = window.OmsMockEmployeesData ? window.OmsMockEmployeesData.createEmployees() : [];

// 車両・ETC・車両予定ダミーデータは mock-vehicles-data.js を単一情報源にする。
const vehiclesData = window.OmsMockVehiclesData ? window.OmsMockVehiclesData.createVehicles() : [];
const VS_KINDS = window.OmsMockVehiclesData ? window.OmsMockVehiclesData.createScheduleKinds() : [];
const vehicleSchedulesData = window.OmsMockVehiclesData ? window.OmsMockVehiclesData.createVehicleSchedules() : [];
const etcCardsData = window.OmsMockVehiclesData ? window.OmsMockVehiclesData.createEtcCards() : [];
