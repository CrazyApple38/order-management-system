...
- **更新者**: Codex (GPT-5)
- **日付**: 2026-06-08
- **コミット**: 6a71ca8（直前 HEAD。本「右プロパティ4モード切替」作業は未コミット）
...
- (Codex) 右プロパティカードの土台枠を、中央メイン表の `.grid-frame` と同じ方向の縁表現へ変更。4辺個別border色（左上やや暗め/右下明るめ）と、内側のごく薄い凹み影・右下ハイライト・内側境界に統一し、外側の浮遊影は撤去。
